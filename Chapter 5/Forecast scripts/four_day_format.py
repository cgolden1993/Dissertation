...
def four_day_format(df1, df2, df3, df4):
    ...
    result = result.drop(result.columns[[0,1,2,7,8,9,10,11,12,13,14,15,20,21,22,23,24,25,
                                         26,27,28,33,34,35,36,37,38,39,40,41,46,47,
                                         48,49,50,51,52,53,54,59,60,61,62,63,64,65,66,67,
                                         72,73,74,75,76,77,78,79,80,85,86,87,88,89,
                                         90,91,92,93,98,99,100,101,102,103,104,105,106,
                                         111,112,113,114,115,116,117,118,119,124,125,
                                         126,127,128,129]], axis=1)

    result = result[['max_wind_speed_four',
                     'max_wind_speed_five',
                     'max_wind_speed_six',
