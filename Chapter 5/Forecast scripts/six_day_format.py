...
def six_day_format(df1, df2):
    ...
    result = result.drop(result.columns[[0,7,8,9,10,11,12,13,20,21,22,23,24,25,26,
                                        33,34,35,36,37,38,39,46,47,48,49,50,51,52,
                                        59,60,61,62,63,64,65,72,73,74,75,76,77,78,
                                        85,86,87,88,89,90,91,98,99,100,101,102,
                                        103,104,111,112,113,114,115,116,117,
                                        124,125,126,127,128,129]], axis=1)
    
    result = result[['max_wind_speed_two',
                 'max_wind_speed_three',
                 'max_wind_speed_four',
                 'max_wind_speed_five',
                 'max_wind_speed_six',
